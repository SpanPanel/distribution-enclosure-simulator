...
from ebus_emitter.conventions.tab_legs import Leg
from ebus_emitter.manifest_physics import CircuitPhysics, PanelPhysics
from ebus_emitter.panel_meter import circuit_current_a, resolve
...
def _circuit(
    *,
    ...
    if legs is None:
        from ebus_emitter.conventions.tab_legs import legs_for_tabs
