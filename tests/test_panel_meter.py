...
from dist_enc_sim.conventions.tab_legs import Leg
from dist_enc_sim.manifest_physics import CircuitPhysics, PanelPhysics
from dist_enc_sim.panel_meter import circuit_current_a, resolve
...
def _circuit(
    *,
    ...
    if legs is None:
        from dist_enc_sim.conventions.tab_legs import legs_for_tabs
